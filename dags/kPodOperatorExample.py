...
collect_data = KubernetesPodOperator(
    ...
    cmds=["bash", "-c"],
    arguments=["pip install pandas && python /opt/airflow/scripts/collect_data.py"],
    env_vars=env_vars,
...
preprocess_data = KubernetesPodOperator(
    ...
    image='python:3.9-slim',
    cmds=["bash", "-c"],
    arguments=["pip install pandas scikit-learn numpy && python /opt/airflow/scripts/preprocess_data.py"],
    env_vars=env_vars,
    volumes=[data_volume_config],
    volume_mounts=[data_volume_mount],
    container_resources = resources,
...
analyze_data = KubernetesPodOperator(
    ...
    image='python:3.9-slim',
    cmds=["bash", "-c"],
    arguments=["pip install pandas matplotlib seaborn numpy && python /opt/airflow/scripts/analyze_data.py"],
    env_vars=env_vars,
    volumes=[data_volume_config],
    volume_mounts=[data_volume_mount],
    container_resources = resources,
...
store_results = KubernetesPodOperator(
    ...
    image='python:3.9-slim',
    cmds=["bash", "-c"],
    arguments=["pip install pandas && python /opt/airflow/scripts/store_results.py"],
    env_vars=env_vars,
    volumes=[data_volume_config],
    volume_mounts=[data_volume_mount],
    container_resources = resources,
